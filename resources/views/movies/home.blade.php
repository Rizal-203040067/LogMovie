  ...
  <section>
    ...
    <div class="flex overflow-x-scroll">
      @foreach ($movies as $movie)
          <div class="card shrink-0 shadow-md rounded-b-lg">
              <a href="/movie/{{ $movie->slug }}"><img class="w-40" src="https://image.tmdb.org/t/p/w400/{{ $movie->poster_path }}" alt="{{ $movie->title }}"></a>
              <div class="mx-4 my-2">
                  <a href="/movie/{{ $movie->slug }}"><p class="font-bold">{{ $movie->title }}</p></a>
                  <p class="text-gray-500 font-medium">{{ $movie->release_date }}</p>
              </div>
          </div>
      @endforeach
    </div>
