...
<div class="flex flex-row mx-6 space-x-6 pb-6">
  <aside class="basis-3/12 space-y-6">
    <div>
      <div>
        <button onclick="myFunction()" type="button" class="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50" id="menu-button" aria-expanded="true" aria-haspopup="true">
          Options
