...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" action="/login" method="POST">
        @csrf
        <div>
          <label for="email" class="block text-sm font-medium leading-6 text-gray-900">Masukan Email</label>
          <div class="mt-2">
      ...
      <br>     
      <a href="/register">
        <span style="color: black;">Belum Punya akun?</span> <span style="color: blue;">Daftar sekarang</span>
      </a>
    </div>
  </div>
</body>
